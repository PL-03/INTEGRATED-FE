    ...
    <div class="mt-2 grid grid-cols-2 items-center">
      <div class="flex justify-start font-lilita">
        <button @click="closeStatusPage" class="ml-48 mt-2 p-2 rounded itbkk-button-home">
          <p class="text-[#aa5b36] decoration-2 hover:underline decoration-[#f8993a]">
            Home
          </p>
        </button>
...
.navbar {
  background: linear-gradient(135deg, rgb(252, 255, 219) 20%, rgb(152, 217, 255)40%, rgb(255, 221, 216) 100%);
}
</style>
