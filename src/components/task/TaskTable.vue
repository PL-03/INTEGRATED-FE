  ...
  <div class="bg-[#dfe0e2] min-h-screen font-lilita">
      ...
      <div class="flex m-4 items-center space-x-6">
        ...
        <div class="flex items-center justify-end">
          ...
          >
            ...
            />
            <div
              class="itbkk-board-visibility w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-500 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"
            ></div>
        ...
        <button
          @click="handleAddTask"
          class="addBtn itbkk-button-add flex items-center text-md text-black hover:text-blue-600 transition duration-300"
          :disabled="!isOwner"
        >
          Add Task
        </button>
        ...
        <button
          ...
          class="itbkk-manage-status flex items-center text-md text-black hover:text-blue-600 transition duration-300"
        >
          Manage Status
        </button>
        ...
        <div class="relative text-black">
          <button
            ...
            class="itbkk-fullname flex items-center hover:text-[#4d5fcb]"
          >
            <svg
              class="mr-2"
    ...
    <div class="p-28">
      ...
      <div class="flex justify-center items-center">
        <table
          class="table-auto w-5/12 md:w-10/12 mx-2 mb-2 rounded-2xl overflow-hidden"
        >
          ...
          >
            <td
              class="px-4 border whitespace-nowrap text-m font-medium text-gray-900 border-r"
            >
              {{ index + 1 }}
            </td>
            <td
              class="itbkk-title px-28 break-all text-m text-gray-900 font-light whitespace-normal border"
            >
            ...
            >
              <button
                class="itbkk-status rounded px-4 py-1 status-text itbkk-status"
                :style="{
            ...
            <td class="flex justify-center px-4 py-2">
              <button
                class="editBtn text-blue-800 hover:text-blue-500 mt-3 ml-2 e-btn itbkk-button-edit"
              ...
              <button
                class="deleteBtn text-red-700 hover:text-red-400 mt-2 d-btn px-4 py-8"
