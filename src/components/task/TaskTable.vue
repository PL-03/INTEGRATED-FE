  ...
  <div class="bg-[#dfe0e2] min-h-screen font-lilita">
      ...
      <div class="flex m-4 items-center space-x-6">
        ...
        <div class="relative text-black">
          <button
            ...
            class="flex items-center hover:text-[#4d5fcb]"
          >
            <svg
              class="mr-2"
          ...
          >
            <ul>
              <li>
                <button
                  @click="logout"
                  class="block w-full text-center px-4 py-2 hover:text-[#ba493f]"
                >
                  Logout
                </button>
              </li>
    ...
    <div class="p-28">
      ...
      <div class="flex justify-center items-center">
        <table
          class="table-auto w-5/12 md:w-10/12 m-2 rounded-2xl overflow-hidden"
        >
