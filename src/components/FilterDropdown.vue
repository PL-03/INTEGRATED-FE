...
<template>
  <div class="relative flex ml-28">
    <div
      class="itbkk-status-filter flex w-72 h-11 px-4 bg-white rounded-md border-gray-300 rounded-l focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-400 overflow-x-scroll"
    >
      <div
        class="itbkk-filter-item mt-2 mb-1 whitespace-nowrap text-gray-500 text-sm"
      >
        <strong class="">Filter by status :</strong>
      </div>
