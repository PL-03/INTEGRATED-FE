  ...
  <div class="bg-gradient-to-t from-gray-500 to-blue-100 min-h-screen">
    ...
    <div class="p-28 ">
      ...
      <div class="flex justify-center items-center ">
        <table class="table-auto w-9/12  m-2 rounded-3xl overflow-hidden">
          <thead class="bg-yellow-950 border-b py-4 text-white">
            <tr>
              ...
              <th class="flex text-lg font-medium text-white px-4 py-2 text-left border-r">
                ...
                <div class="rounded-md flex bg-white px-1 py-1 ml-4">
                  <button
                    class=" ml-1 rounded-md px-1 py-1 bg-white text-yellow-950 focus:bg-yellow-200 hover:bg-yellow-200 hover:text-black"
                    @click="handleSortData('Asc')"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                      viewBox="0 0 24 24">
                      <path fill="currentColor"
          ...
          <tbody>
            <tr v-for="(task, index) in filteredTasks" :key="index"
              ...
              <td class="break-all text-m text-gray-900 font-light whitespace-normal border itbkk-title">
              ...
              <td class="text-m text-gray-900 font-light px-4 py-2 border whitespace-normal itbkk-status">
                <button class="status font-bold py-2 px-4 rounded status-text itbkk-status" :style="{
