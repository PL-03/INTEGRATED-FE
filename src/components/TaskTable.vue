  ...
  <div class="bg-gradient-to-t from-gray-500 to-blue-100 min-h-screen">
    <nav class="h-20 flex justify-between shadow-md bg-blue-950 fixed left-0 right-0 top-0 z-10 min-w-screen">
      <div class="image flex h-14 m-2">
        ...
        <h1 class="text-start text-wrap text-2xl font-serif font-bold p-4 text-white">
      ...
      <div class="flex m-4">
        <button
          ...
          @click="handleAddTask">
          <svg class="mr-1" xmlns="http://www.w3.org/2000/svg" width="12" height="22" viewBox="0 0 20 20">
        ...
        <button
          ...
          <svg class="mr-1" xmlns="http://www.w3.org/2000/svg" width="14" height="22" viewBox="0 0 2048 2048">
    ...
    <div class="p-28">
      ...
      <div class="flex justify-center items-center">
        <table class="table-auto w-10/12 m-2 rounded-3xl overflow-hidden">
          <thead class="bg-yellow-950 border-b py-4 text-white">
            <tr>
              ...
              <th class="flex text-lg font-medium text-white px-4 py-2 text-left border-r">
                Status

                <div class="itbkk-status-sort rounded-md flex bg-white px-1 py-1 ml-4">
                  <button
                    class="ml-1 rounded-md px-1 py-1 bg-white text-yellow-950 focus:bg-yellow-200 hover:bg-yellow-200 hover:text-black"
                  ...
                  <button
                    class="text-sm ml-1 mr-1 rounded-md px-2 bg-white text-yellow-950 focus:bg-yellow-200 hover:bg-yellow-200 hover:text-black"
          ...
          <tbody>
            <tr v-for="(task, index) in filteredTasks" :key="index"
              ...
              <td class="px-4 py-2 border whitespace-nowrap text-m font-medium text-gray-900 border-r">
                {{ index + 1 }}
              </td>
              <td class="itbkk-title break-all text-m text-gray-900 font-light whitespace-normal border">
                <button class="itbkk-title" @click="handleViewTask(task)">{{ task.title }}</button>
              </td>
              ...
              <td class="text-m text-gray-900 font-light px-4 py-2 border whitespace-normal itbkk-status">
                <button class="itbkk-status font-bold py-2 px-4 rounded status-text itbkk-status" :style="{
