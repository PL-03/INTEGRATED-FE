  ...
  <div class="bg-gradient-to-t from-gray-500 to-blue-100 min-h-screen">
    ...
    <div class=" flex justify-center items-center ">
      <table class="table-auto w-9/12 m-2 rounded-2xl overflow-hidden">
        ...
        <tbody>
          <tr v-for="(task, index) in tasks" :key="task.id" :class="index % 2 === 0 ? 'bg-yellow-50' : 'bg-orange-100'"
            ...
            <td class="flex justify-center px-4 py-2 ">
              <!-- //edit -->
              <button class=" text-blue-800 hover:text-blue-500 mt-3 ml-2 e-btn" @click="handleEditTask(task)"><svg
