  ...
  <div class=" bg-[#3e3e44] min-h-screen font-lilita">
    <nav
      ...
      <div class="image flex h-14 m-2">
        ...
        <h1 class="text-start text-wrap text-2xl font-lilita p-4 text-white tracking-wide">
      ...
      <div class="flex m-4">
        ...
        <button class="flex text-sm px-3 py-1 mt-3 text-white hover:text-[#45e971]  rounded itbkk-button-add"
          @click="handleAddTask">
        ...
        <button class="flex text-sm px-3 py-1 mt-3 ml-1 text-white  hover:text-[#6fd4ff] rounded itbkk-manage-status"
          @click="handleStatusList">
          <svg class="mr-1 " xmlns="http://www.w3.org/2000/svg" width="14" height="22" viewBox="0 4 20 20">
        ...
        <p class="mx-2 text-sm text-[#fffcb3] ]" @click="handleLoginPage">
          <svg class="ml-4" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
            <path fill="currentColor"
        ...
        <table class="table-auto w-10/12 m-2 rounded-2xl overflow-hidden ">
          ...
          <tbody v-for="(task, index) in filteredTasks" :key="index"
            ...
            <td class="text-m text-gray-900 font-light border whitespace-normal itbkk-status">
              <button class="itbkk-status py-2 px-4 rounded status-text itbkk-status" :style="{
