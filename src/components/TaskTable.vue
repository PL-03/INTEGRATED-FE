...
<template>
  <div class="bg-gradient-to-t from-gray-700 to-blue-100 min-h-screen">
    ...
    <div class="mt-2 mr-44 flex justify-end items-center">
      <button
        class="flex mt-4 bg-green-500 hover:bg-emerald-500 text-white font-bold p-2 rounded itbkk-button-add"
        @click="handleAddTask"
      >
        <svg
          class="mr-1"
      ...
      <button
        class="flex mt-4 ml-2 bg-blue-700 hover:bg-sky-500 text-white font-bold p-2 rounded itbkk-button-add"
        ...
        <tbody>
          ...
          >
            ...
            <td class="flex px-4 py-2">
              <!-- //edit -->
              <button
                class="text-blue-800 hover:text-blue-500 mt-3 mb-2 e-btn"
