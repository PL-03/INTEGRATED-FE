  ...
  <div class="bg-gradient-to-t from-gray-500 to-blue-100 min-h-screen">
    ...
    >
      <div class="image flex h-14 m-2">
        ...
        <h1
          class="text-start text-wrap text-2xl font-serif font-bold p-4 text-white"
        >
        ...
        <table class="table-auto w-10/12 m-2 rounded-3xl overflow-hidden">
          <thead class="bg-yellow-950 border-b py-4 text-white">
            <tr>
              ...
              <th
                class="flex text-lg font-medium text-white px-4 py-2 text-left border-r"
              >
                Status

                <div
                  class="itbkk-status-sort rounded-md flex bg-white px-1 py-1 ml-4"
                >
                  <button
          ...
          <tbody>
            ...
            >
              ...
              >
                <button
                  class="itbkk-status font-bold py-2 px-4 rounded status-text itbkk-status"
                  :style="{
