...
<template>
  ...
  <div class="bg-[#dfe0e2] min-h-screen font-lilita">
    ...
    <div class="flex justify-center p-32">
      <div>
        <div
          class="flex justify-center items-center text-center gap-4 text-3xl drop-shadow-lg"
        >
          Board List
        </div>
      </div>
    ...
    <div class="flex justify-center items-center">
      <table
        ...
        class="table-auto w-10/12 m-2 rounded-2xl overflow-hidden itbkk-table"
      >
        <thead>
          <th>No.</th>
          <th>Name</th>
      ...
      <div
        v-else
        class="flex justify-center text-center gap-4 text-xl drop-shadow-lg text-gray-500 italic"
      >
        No Board!
      </div>
    </div>
