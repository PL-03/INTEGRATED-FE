...
<template>
  ...
  <div class="bg-[#dfe0e2] min-h-screen font-lilita">
    ...
    <!-- <div v-if="boards.length !== 0" class="flex flex-col justify-center items-center p-28">
      ...
      <table class="table-auto w-full max-w-5xl rounded-2xl overflow-hidden itbkk-table bg-green-300 ">
        <thead>
          <tr>
            <th>No.</th>
            <th>Name</th>
        ...
        <tbody v-for="(board, index) in boards" :key="index" :class="index % 2 === 0 ? 'bg-yellow-50' : 'bg-orange-100'"
