      ...
      <table class="table rounded-md overflow-hidden itbkk-table bg-green-300">
        ...
        >
          <tr class="itbkk-item">
            <td>{{ index + 1 }}</td>
            <td>
              <button @click="handleViewBoard(board.id)" class="itbkk-name">
                <!-- name ยังไม่ได้ใส่ -->
              </button>
            </td>
            <td>
              <!-- E-mail -->
              <span class="itbkk-email text-[#4d5fcb]">{{
                board.owner.name
              }}</span>
            </td>
            <td>
            ...
            <td>
              <button
                class="itbkk-collab-remove bg-[#adafb5] text-white text-sm py-1 px-2 rounded hover:bg-[#888a94]"
              >
                Remove
              </button>
            </td>
