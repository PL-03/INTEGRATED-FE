    ...
    <div
      ...
      <div class="w-full md:w-auto mt-4 md:mt-0 mx-4 md:mx-14">
        <div class="flex flex-col items-center md:items-start gap-3 mr-12">
          ...
          <div class="itbkk-username flex flex-col items-center md:items-start gap-1 w-full">
            <label for="username" class="text-white text-sm">USERNAME</label>
            <input v-model="loginInfo.userName" type="text" maxlength="50"
              class="bg-white w-full md:w-72 h-9 rounded-lg py-2 px-3" placeholder="Enter your username" />
          </div>
          <div class="itbkk-password flex flex-col items-center md:items-start gap-1 w-full">
            ...
            <input v-model="loginInfo.password" type="password" maxlength="14" id="password"
              class="bg-white w-full md:w-72 h-9 rounded-lg py-2 px-2" placeholder="Enter your password" />
          </div>
