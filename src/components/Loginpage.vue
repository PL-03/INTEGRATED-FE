...
<template>
  ...
  <div class="flex items-center justify-center min-h-screen bg-[#3e3e44]">
    ...
    >
      <div
        class="w-full md:w-7/12 h-72 md:h-96 bg-[#fffc9c] mr-0 md:mr-22 rounded-2xl shadow-[6px_0_15px_0px_rgba(255,255,255,0.4)] flex items-center justify-center mt-4 md:mt-0"
      >
        <div class="text- m-0 md:m-4">
          <h1 class="text-xl md:text-4xl font-bold mb-2 text-[#313175]">
            Welcome To
          </h1>
          <h2 class="text-lg md:text-2xl text-[#75483b]">ITB - KK</h2>
      ...
      <div class="w-full md:w-auto mt-4 md:mt-0 mx-4 md:mx-14">
        <div class="flex flex-col items-center md:items-start gap-3">
          ...
          <div
            class="itbkk-password flex flex-col items-center md:items-start gap-1 w-full"
          >
            ...
            <input
              ...
              type="password"
              id="password"
              class="bg-white w-full md:w-72 h-9 rounded-lg py-2 px-2"
